 ...
 *         A LibraryHolding has an identifier, a current status, a due date (if
 *         checked out),
 *         and a list of users that have requested the book. A separate instance
 *         variable
...
public abstract class LibraryHolding {
     ...
     * initialises an empty request queue, and sets numCompies to 1.
     */
     ...
     *         This method only changes the status of the item and not of the
     *         user
