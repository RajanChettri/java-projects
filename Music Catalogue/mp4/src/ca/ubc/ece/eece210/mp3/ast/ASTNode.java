...
public abstract class ASTNode {
    ...
    // adds its children based on its token arguments // maybe find a way to
    // turn token to node so we can use token argument
    public ASTNode(ASTNode firstChild, ASTNode secondChild) {
        children = new ArrayList<ASTNode>( 2 );
